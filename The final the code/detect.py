            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        centre_point,area= plot_one_box(xyxy, im0, label=label, color=colors[int(cls)],
                                                          line_thickness=3)
                        datas.append(centre_point)
                        areas.append(area)
                        # Stream results
                        if view_img:
...
#     parser.add_argument('--source', type=str, default='54.jpg', help='source')  # file/folder, 0 for webcam
